...
class FullyConvolutionalResNeSt(ResNet):
    ...
    def __init__(self, num_class=1000, model_name='resnest50_fast_1s4x24d', **kwargs):
        if model_name == 'resnest50_fast_1s4x24d':
            ...
            state_dict = torch.load('./pretrainedResNeSt/resnest50_fast_1s4x24d-d4a4f76f.pth')
            self.load_state_dict(state_dict)
        else:
            raise NotImplementedError('Currently only resnest50_fast_1s4x24d is supported')
